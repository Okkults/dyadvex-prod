...
const faqGroups = [{
  ...
  intro: "A quantitative machine intelligence that treats the market as a non-linear stochastic process. No guesses, no news, no stories — only math.",
  items: [{
    q: "What is dyadvex?",
  ...
  intro: "dyadvex is in the same lonely, high-potential phase the most successful quant fund in history occupied at its founding — a small system with real signal, waiting for scale.",
  items: [{
  ...
  intro: "We operate in a market saturated with unverifiable track records, simulated backtests, and selectively audited performance. We do not rely on any of them.",
  items: [{
  ...
  intro: "Capital is partitioned across a dual-layer system: high-variance earnings exposure and low-variance macro overnight exposure. Risk is not eliminated — it is priced and controlled independently across regimes.",
  items: [{
  ...
  intro: "The core edge is not the model. It is the dataset architecture, the research methodology, and the continuous recalibration loop on top of them.",
  items: [{
...
function FAQPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { numeral: "VI", eyebrow: "Inquiry", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    "Questions admitted ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "by the model." })
  ] }), lede: "Direct answers — not defensive ones. Why the edge exists, how it is harvested, when it dies, and how dyadvex proves scale without a giant fund.", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-20", children: faqGroups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-[180px_1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-[11px] uppercase tracking-[0.3em] text-gold", children: [
        group.numeral,
        " ·"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 font-display text-2xl leading-tight", children: group.heading }),
      group.intro && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 font-sans text-xs leading-relaxed text-muted-foreground", children: group.intro })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "w-full", children: group.items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: `${group.heading}-${idx}`, className: "border-b border-gold/15", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "py-5 text-left font-display text-lg leading-snug hover:no-underline", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-gold/60 pt-2", children: String(idx + 1).padStart(2, "0") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.q })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "pb-6 pl-10 font-sans text-sm leading-relaxed text-muted-foreground", children: item.a })
    ] }, idx)) })
  ] }, group.heading)) }) });
}
export {
